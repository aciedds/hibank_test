...
import 'package:hibank_test/data/model/auth_model/auth_model.dart';
...
class AuthRemote {
  ...
  Future<DataState<AuthModel>> signInWithGoogle() async {
    try {
      ...
      if (result.user != null) {
        return DataState.success(
          data: AuthModel.fromFirebaseUser(result.user!),
        );
      } else {
        return const DataState.error(message: "Error: User is null");
      }
